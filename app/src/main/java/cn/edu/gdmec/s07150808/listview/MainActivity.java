...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, 2, 0, "SimpleCursorAdater");
    ...
    public void arrayAdater() {
        //准备资源数组。
        final String time[] = {"Sun", "Mon", "Tue", "wed", "Thu", "Fri", "sat"};
    ...
    private void simpleCursorAdater() {
        /*
   ...
   /    根据URI对象ContactsContract.Contacts.CONTENT_URI查询所有联系人；
    ...
    public void simpleAdater() {
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, list, R.layout.simpleadater_demo, new String[]{"img", "title", "info"}, new int[]{R.id.imageView, R.id.titleView, R.id.infoView});
